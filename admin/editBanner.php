    ...
    $validator->addValidation("category_id","req","Please select category");
	  ...
	  if($validator->ValidateForm()){
		if(!$_FILES["file"]["name"]){
				...
				$class->_delete_file('../uploads/right_banner/',$row['adv_image']);
			...
			$condi="pri_ID='$id'";
			$class->UpdateQuery('right_banner',$field,$condi); 
			$view='viewBanner.php';
        ...
        <table width="99%" border="0" cellspacing="1" cellpadding="3">
            ...
            <tr>
                ...
                <td align="left" valign="top" colspan="2">
                  <input class="inp-text" name="file" id="file"  type="file" size="18" />	<img src="../uploads/right_banner/<?php echo $image;?>"  height="50" width="50"/>											  </td>
          </tr>
    <tr>
