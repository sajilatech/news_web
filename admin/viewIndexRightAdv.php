...
$class=new Common();
$sql="SELECT * FROM index_right_adv";
...
if(isset($_REQUEST['mode'])){
	...
	switch($mode){
		case'delete':
			$c="pri_ID='$id'";
			$row=$class->getRowByID('index_right_adv','pri_ID',$id,$condi='');
			$class->upload_file($path,$row['adv_image']);
				$class->deleteQuery('index_right_adv',$c);
...
<div id="content">
  ...
  <div class="feature"> <div id="pageName">Home page top right advertisements</div></div>
  <div class="story">			
       ...
       <?php 
        ...
        <tr>
           <td><?php echo $count;?></td>
            <td><img src="../uploads/index_right_adv/<?php echo $row['adv_image'];?>"  height="75" width="145" /> </td>
            

             <td><a href="editIndexRightAdv.php?current_tab=<?php echo $current_tab;?>&id=<?php echo $row['pri_ID'];?>">
