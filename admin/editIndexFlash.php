...
?>
<?php 
$row=$class->getRowByID('index_flash','news_ID',$id,$condition='');
  ...
  if(isset($_POST['Submit'])){
		...
		$category_id=$_POST['category'];
	  	if($validator->ValidateForm()){
			...
			$condi="news_ID='$id'";
			$class->UpdateQuery('index_flash',$field,$condi);	
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr>
         ...
         <tr>
          ...
          <td align="left" valign="top" colspan="2"><input class="inp-text" name="file" id="file"  type="file" /><img src="../thumbnails/<?php echo $image;?>"  height="50" width="50"/>
          </td>
        </tr>
 <tr>
          <td align="left" valign="top">Big image</td>
          <td align="left" valign="top" colspan="2"><input class="inp-text" name="file2" id="file2"  type="file" /><img src="../photos/<?php echo $image2;?>"  height="50" width="50"/>
          </td>
        </tr>
