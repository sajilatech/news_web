...
$top_banner=$class->getRowByID('top_banner','category_ID','8',$condi='');
...
<div id="menu_in">
		...
		<?php
			...
			?>
            <li> <a href="photos.php" class="current">Photos</a></li>
...
<div id="gallery">
    <ul>
        <li>
            <a href="photos/image1.jpg" title="ghggghg">
                <img src="photos/thumb_image1.jpg"  />
            </a>
            <div id="gallery_dtls">
            <h2>gfdgdfggh hgjghj</h2>
            <p>sbhgsadjghjghjghjfugdsfu</p>
            </div>
        </li>
        
        <li>
            <a href="photos/image2.jpg" title="ghfggfghg">
                <img src="photos/thumb_image2.jpg"  />
            </a>
            <div id="gallery_dtls">
            <h2>gfdgdfgfdhdf</h2>
            <p>sbhgsadfugjghjghjhgjhgjhgdsfu</p>
            </div>
        </li>
        <li>
            <a href="photos/image3.jpg" title="fghfghgh">
                <img src="photos/thumb_image3.jpg"  />
            </a>
            <div id="gallery_dtls">
            <h2>gfdgdfgfdhdf</h2>
            <p>sbhgsadfujghjghjghjhgjgdsfu</p>
            </div>
        </li>
        <li>
            <a href="photos/image4.jpg" title="fghfgfghgh">
                <img src="photos/thumb_image4.jpg" />
            </a>
            <div id="gallery_dtls">
            <h2>gfdgdfgfdhdf</h2>
            <p>sbhgsadfhgjghjghjghjugdsfu</p>
            </div>
        </li>
        <li>
            <a href="photos/image5.jpg" title="hfghfghhggh">
                <img src="photos/thumb_image5.jpg"  />
            </a>
            <div id="gallery_dtls">
            <h2>gfdgdfgfdhdf</h2>
            <p>sbhgsadfhgjghjghjghjghjugdsfu</p>
            </div>
        </li>
    </ul>
</div>
